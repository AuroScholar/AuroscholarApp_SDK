...
public class StateSpinnerUserAdapter extends ArrayAdapter {
    ...
    public StateSpinnerUserAdapter(@NonNull Context context, int resource, List<StateDataModelNew> list, CommonCallBackListner onItemClickState) {
...
/*    public StateSpinnerUserAdapter(List<StateDataModel> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        binding.stateTitle.setText(list.get(position).getStateName());
