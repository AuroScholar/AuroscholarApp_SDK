                    ...
                    public void onResponse(Call<SetUsernamePinResModel> call, Response<SetUsernamePinResModel> response) {
                        try {
                            ...
                            if (response.code() == 400) {
                                ...
                                Toast.makeText(SetParentPinActivity.this, "Error! This pin is already used in your other account. Please enter other pin!", Toast.LENGTH_SHORT).show();
                            ...
                            Toast.makeText(SetParentPinActivity.this, "Internet connection", Toast.LENGTH_SHORT).show();
                        }
                    }
