...
class BotProductAdapter(val context: Context, var list: List<ResponseBot.Product>) :
...
//                holder.title.text = modelResult.title!!
...
//                holder.description.text = modelResult.description!!
